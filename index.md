...
My start in computer science began in early 2019, where waking up one morning after working in retail for 10 years at the time and realizing that I didn’t want to continue on that path, so after that day I decided to enroll in the computer science program at Southern New Hampshire University. I was drawn to computer science because I enjoy working with technology and solving problems, but I knew from the start that this would be a challenge to complete, since I had no prior experience with any type of programming. After completing this ePortfolio, it was great to see the progress that I have made, from learning my first language with Python, to now knowing how to code with Python, C++, Java and learning critical skills including collaborating in a team environment, communicating to stakeholders, data structures and algorithms, software engineering, databases and secure coding. 
